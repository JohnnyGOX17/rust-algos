//! # Heap
//!
//! Provide an implementation of a [binary heap](https://en.wikipedia.org/wiki/Binary_heap).
//! ![binary tree](https://media.geeksforgeeks.org/wp-content/cdn-uploads/binaryheap.png)
//!
